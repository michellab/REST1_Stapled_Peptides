...
if __name__ == "__main__":
    ...
    parser.add_argument("-nreps", type=int, default=11, help='number of replicas (default: %(default)s)')
    parser.add_argument("-smax", type=float, default=2, help="maximum scaling factor (default: %(default)s)")
